...
import './components/explode-widget.js';
    ...
    return html`
      ...
      <main>      
        ...
        <widget-container header="Widgets">
          <ad-widget></ad-widget>
          <widget-block header="Calender"></widget-block>
 
          <widget-block header="Explode"></widget-block>

          <widget-block header="Timer"></widget-block>
 Christian
        </widget-container>
      </main>
